...
void initCategoriesDependencies() {
  sl.registerFactory<CategoryRemoteDataSource>(() {
    if (HardcoreSession.isActive) return MockCategoryRemoteDataSource();
    return CategoryRemoteDataSourceImpl(sl<FirebaseFirestore>());
  });
